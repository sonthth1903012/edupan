            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        <div style="background-image: url(img/bg-img/pc-1.jpg); width: 100%; height: 200px"></div>
                        <div class="d-flex">
                            <div>
                                <h5>Xu hướng giáo dục cho trẻ</h5>
                                <p>Địa điểm: Khách sạn Melia - Hai Bà Trưng - Hà Nội</p>
                                <p>Thời gian: 14h-18h, March 18, 2021</p>
                                <p>Phí tham gia: Miễn phí</p>
                            </div>
                            <div>
                                <a href="http://localhost/edupan/public/post_detail" class="btn academy-btn btn-sm">Tham gia</a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <div class="popular-course-content">
                            ...
                            <span>Địa điểm: Khách sạn Melia - Hai Bà Trưng - Hà Nội</span>
                            <span>Thời gian: 14h-18h, March 18, 2021</span>
